...
/// <summary>
/// Custom JSON converter for ComponentSchema that handles the custom serialization
/// where sections, tabs, and fields are stored as a flat dictionary with type discrimination.
/// </summary>
public sealed class ComponentSchemaJsonConverter : JsonConverter<ComponentSchema>
{
    ...
    public override ComponentSchema? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return DeserializeSchema(doc.RootElement);
    }

    public override void Write(Utf8JsonWriter writer, ComponentSchema value, JsonSerializerOptions options)
    {
        SerializeSchema(writer, value);
    }
